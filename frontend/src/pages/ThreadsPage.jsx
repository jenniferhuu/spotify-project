        ...
        <div className="flex h-screen">
            ...
            <main className="flex-1 bg-[#EEEEEE] overflow-y-auto">
                <div style={containerStyle}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0 24px', fontSize: '11px', fontWeight: '600', color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                        ...
                        {loading ? (
                            ...
                            <p style={{ color: '#6b7280', fontSize: '14px' }}>No threads yet. Start one!</p>
                        ) : (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                {threads.map(thread => (
                                    <ThreadCard
